...
module Parser
  ...
  class Moola
    attr_reader :doc
		...
		def get_school
      logo_url = "http://moola.fi/Site/Yhteystiedot_files/Screen%20shot%202009-09-06%20at%2011.41.03%20AM.jpg"
			return Model::School.new(name="Moola", homepage="http://moola.fi", studios=get_studios, logo_url, id="Moola")
		end
